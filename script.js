window.onload = () => {
  ...
  let s = 0, cp = 1, ar = 0, pr = 1, ct = 0, b = 0, mc = 1;
  ...
  const updateStats=()=>{
    ...
    $("totalUpgrades").textContent=b;
    maxPerClickEl.textContent=fmt(mc);
    prestigeMultEl.textContent=pr.toFixed(2)+"×";
  };

  // Досягнення
  const achs=[["Перший клік",()=>ct>=1,1],["100 сек",()=>s>=100,100],["Перша покупка",()=>b>=1,1],["Авто",()=>ar>0,1],["Комбо-майстер",()=>mx>=10,10],["Стильний",()=>skin.sh!=="round"||skin.col!=="neon-blue",1]];
